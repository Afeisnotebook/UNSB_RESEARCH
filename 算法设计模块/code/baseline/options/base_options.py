...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--seed', type=int, default=2026, help='random seed (-1 disables explicit seeding)')
        ...
        parser.add_argument('--netD', type=str, default='basic_cond', choices=['basic', 'basic_cond', 'n_layers', 'pixel', 'patch', 'tilestylegan2', 'stylegan2'], help='specify discriminator architecture. The basic model is a 70x70 PatchGAN. n_layers allows you to specify the layers in the discriminator')
