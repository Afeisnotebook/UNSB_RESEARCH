...
| 当前结论 | SEARCH-002 完成：finite-horizon HJ 为 `positive_but_fragile` 第一候选；HNEK 为递补一；LTTR 与四个新机制当前实现关闭。 |
| 时间线位置 | DT=T1，HJ=T2/T10，HNEK=T3，clean 统一裁决=T5，新机制=T8，方向重推导=T10。 |
...
| CAND-002 | HJ-PatchNCE | DEVELOPMENT_FROZEN / positive_but_fragile | finite-horizon HJ → plain handoff；待 4090 |
| CAND-003 | HNEK | FALLBACK-1 / positive_but_fragile | gamma=0.25 physical residual |
