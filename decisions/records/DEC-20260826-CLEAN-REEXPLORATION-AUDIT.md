...
同时，当前精简 baseline 虽能稳定重放自身输出，但不与 2026-08-11 完整历史研究代码的 PNG 字节一致。该差异保留为历史 provenance；它阻止的是“声称精确复原旧轨迹”，不阻止把当前严格确定性代码冻结为新的 canonical。完整结果见 [L0 real-data micro validation](../../experiments/L0-contract/EXP-L0-CANONICAL-MICRO-20260826/REPORT.md)。
