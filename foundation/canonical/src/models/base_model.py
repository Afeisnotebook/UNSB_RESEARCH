...
class BaseModel(ABC):
    ...
    def __init__(self, opt):
        ...
        if opt.preprocess != 'scale_width' and not torch.backends.cudnn.deterministic:  # with [scale_width], input images might have different sizes, which hurts the performance of cudnn.benchmark.
