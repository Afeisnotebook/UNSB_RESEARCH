...
class UnalignedDataset(BaseDataset):
    """Load unaligned A/B images, optionally with the frozen DCUM sampler.

    It requires ``trainA``/``trainB`` (or the corresponding phase names).
    DCUM remains unpaired: it draws B uniformly from A's domain and excludes
    the same stem, without storing or reusing a fixed A-to-B mapping.
    """
