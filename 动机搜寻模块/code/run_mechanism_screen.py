...
def run_smoke() -> None:
    ...
    _run(
        [
            PY,
            str(ROOT / "code" / "mechanism_direction_rank.py"),
            "--root",
            str(ROOT),
            "--refactor-root",
            REFACTOR,
    ...
    _run(
        [
            PY,
            str(ROOT / "code" / "mechanism_gradient.py"),
            "--root",
            str(ROOT),
            "--refactor-root",
            REFACTOR,
    ...
    _run(
        [
            PY,
            str(ROOT / "code" / "mechanism_feature_alignment.py"),
            "--root",
            str(ROOT),
            "--refactor-root",
            REFACTOR,
...
def run_full() -> None:
    ...
    _run(
        [
            PY,
            str(ROOT / "code" / "mechanism_compression_window.py"),
            "--raw-dir",
            str(ROOT / "raw"),
            "--direction-rank-json",
            str(REPORT_DIR / "direction_rank.json"),
